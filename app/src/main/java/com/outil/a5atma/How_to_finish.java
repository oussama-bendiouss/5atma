...
public class How_to_finish extends AppCompatActivity {
   String msg;
    ...
    public void how_many(View view) {
        ...
        switch(tag){
            case "1":
                msg = "لختم القرآن مرة واحدة في الشهر،يجب عليك قراءة حزب بعد صلاة الفجر و آخر بعد صلاة المغرب";
                break;
            case "2":
                msg = "لختم القرآن مرتين في الشهر، يجب عليك قراءة حزب بعد صلاة الفجر،الظهر،المغرب،العشاء. لماذا هذه الأوقات بالضبط؟ لأنك أخي المسلم في هذه الأوقات تكون غير مشغول بأمور الدنيا";
                break;
            case "3":
                msg ="لختم القرأن ثلات مرات ، يجب عليك قراءة حزب قبل صلاة الفجر و المغرب ، و حزب بعد صلاة الفجر و المغرب، بالإضافة إلى حزب بعد صلاة الظهر و العشاء";
                break;
            case "4":
